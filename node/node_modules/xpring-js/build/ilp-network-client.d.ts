...
export interface IlpNetworkClient {
     ...
     */
    getBalance(request: GetBalanceRequest, bearerToken?: string): Promise<GetBalanceResponse>;
    /**
     ...
     */
    send(request: SendPaymentRequest, bearerToken?: string): Promise<SendPaymentResponse>;
