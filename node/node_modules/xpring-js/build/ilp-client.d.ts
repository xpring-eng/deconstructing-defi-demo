...
declare class IlpClient {
    private readonly decoratedClient;
    constructor(grpcURL: string, forceWeb?: boolean);
    /**
     ...
     */
    getBalance(accountId: string, bearerToken?: string): Promise<GetBalanceResponse>;
    /**
     ...
     */
    send(amount: BigInteger | number | string, paymentPointer: string, sender: string, bearerToken?: string): Promise<SendPaymentResponse>;
}
