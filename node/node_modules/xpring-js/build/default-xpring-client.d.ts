 ...
 */
declare class DefaultXpringClient implements XpringClientDecorator {
     ...
     */
    static defaultXpringClientWithEndpoint(grpcURL: string, forceWeb?: boolean): DefaultXpringClient;
    /**
     ...
     */
    send(drops: BigInteger | number | string, destinationAddress: string, sender: Wallet): Promise<string>;
