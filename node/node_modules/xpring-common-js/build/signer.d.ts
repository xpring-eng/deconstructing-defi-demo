...
declare class Signer {
     ...
     */
    static signTransaction(transaction: Transaction, wallet: Wallet): Uint8Array | undefined;
    /**
     * Encode the given object to hex and sign it.
     *
     ...
     */
    static signLegacyTransaction(transaction: LegacyTransaction, wallet: Wallet): SignedTransaction | undefined;
}
